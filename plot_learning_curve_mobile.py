...
# plt.savefig("charts/DT_mobile_final")
# plt.clf()
...
# clf = GradientBoostingClassifier(n_estimators=50, learning_rate=0.7, max_depth=2, random_state=0, min_samples_leaf=5)
# plot_learning_curve(clf, title, X, y, axes=axes, ylim=(0.3, 1.01),
#                     cv=cv, n_jobs=-1)

# plt.savefig("charts/boosting_mobile")
# plt.clf()
...
# plt.savefig("charts/KNN_final_mobile")
# plt.clf()
...
# title = "Learning Curves (SVM - poly_deg=8)"
